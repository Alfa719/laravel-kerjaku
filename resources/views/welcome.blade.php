...
@section('title', 'Kerjaku-Dashboard')

@section('content')
    <!-- ======= Services Section ======= -->
    <section id="job" class="services section-bg">
        <div class="container" data-aos="fade-up">

            <div class="section-title">
                <h2>Job</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic ullam possimus ad libero ex velit?
                </p>
            </div>
    ...
    <section id="mitra" class="team section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Mitra</h2>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis fugiat neque animi sint ea
                    nostrum!</p>
            </div>
